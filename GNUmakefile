...
ifeq ($(debugging), yes)
ADDITIONAL_OBJCFLAGS += -DGNUSTEP -DNO_ATTRIBUTED_TITLES -std=c99 -Wno-import -Werror -Wno-typedef-redefinition -g -fobjc-arc
else
ADDITIONAL_OBJCFLAGS += -DGNUSTEP -DNO_ATTRIBUTED_TITLES -std=c99 -Wno-import -Werror -Wno-typedef-redefinition -g -fobjc-arc -DDNDEBUG=1
endif
